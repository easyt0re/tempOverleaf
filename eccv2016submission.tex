...
\pagestyle{headings}
\mainmatter
\def\ECCV16SubNumber{20181108}  % Insert your submission number here

\title{A Pre-processing Script for PyTorch ML Problem} % Replace with your title
...
\author{Yang Wang}
\institute{Date \ECCV16SubNumber}
